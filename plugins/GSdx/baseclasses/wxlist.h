...
public:
	...
	WXLIST_POSITION GetHeadPosition() const
	{
		return (WXLIST_POSITION)m_pFirst;
	}
	WXLIST_POSITION GetTailPosition() const
	{
		return (WXLIST_POSITION)m_pLast;
	}
	int GetCount() const
	...
	OBJECT *GetNext(WXLIST_POSITION &rp) const
	{
		return (OBJECT *) GetNextI(rp);
	}

	OBJECT *Get(WXLIST_POSITION p) const
	{
	...
	OBJECT *Remove(WXLIST_POSITION p)
	{
		return (OBJECT *) RemoveI(p);
	}
	WXLIST_POSITION AddBefore(WXLIST_POSITION p, OBJECT * pObj)
	{
		return AddBeforeI(p, pObj);
	}
	WXLIST_POSITION AddAfter(WXLIST_POSITION p, OBJECT * pObj)
	{
		return AddAfterI(p, pObj);
	}
	WXLIST_POSITION AddHead(OBJECT * pObj)
	{
		return AddHeadI(pObj);
	}
	WXLIST_POSITION AddTail(OBJECT * pObj)
	{
	...
	WXLIST_POSITION Find(OBJECT * pObj) const
	{
		return FindI(pObj);
	}
}; // end of class declaration
