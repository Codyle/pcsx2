...
template <class T> inline T RAD_2_DEG(T radians)
{
...
public:
	...
	operator const dReal* () const
	{
		return (const dReal*)&x;
	}

	// SCALAR FUNCTIONS
	inline dReal dot(const Vector &v) const
	{
	...
	inline void Set3(const float* pvals)
	{
		x = pvals[0];
		y = pvals[1];
		z = pvals[2];
	}
	inline void Set4(const float* pvals)
	{
		x = pvals[0];
		y = pvals[1];
		z = pvals[2];
	...
	inline Vector operator*(dReal k) const
	{
		Vector v;
		v.x = k * x;
		v.y = k * y;
	...
	inline Vector &operator *= (const dReal k)
	{
		x *= k;
		y *= k;
		z *= k;
	...
	inline Vector &operator /= (const dReal _k)
	{
		dReal k = 1 / _k;
		x *= k;
		y *= k;
...
inline dReal* mult3(dReal* pfres, const dReal* pf1, const dReal* pf2)
{
	return _mult3<dReal>(pfres, pf1, pf2);
}
inline double* mult3(double* pfres, const double* pf1, const double* pf2)
{
	return _mult3<double>(pfres, pf1, pf2);
}
...
inline dReal* mult4(dReal* pfres, const dReal* pf1, const dReal* pf2)
{
	return _mult4<dReal>(pfres, pf1, pf2);
}
inline double* mult4(double* pfres, const double* pf1, const double* pf2)
{
...
inline dReal* multtrans3(dReal* pfres, const dReal* pf1, const dReal* pf2)
{
	return _multtrans3<dReal>(pfres, pf1, pf2);
}
inline double* multtrans3(double* pfres, const double* pf1, const double* pf2)
{
...
inline dReal* multtrans4(dReal* pfres, const dReal* pf1, const dReal* pf2)
{
	return _multtrans4<dReal>(pfres, pf1, pf2);
}
inline double* multtrans4(double* pfres, const double* pf1, const double* pf2)
{
...
inline dReal* inv3(const dReal* pf, dReal* pfres, int stride)
{
	return _inv3<dReal>(pf, pfres, stride);
}
