...
public:
	...
	WXFARPROC MSWGetOldWndProc() const
	{
		return m_oldWndProc;
	}
	void MSWSetOldWndProc(WXFARPROC proc)
	{
		m_oldWndProc = proc;
	}
	...
	virtual bool ContainsHWND(WXHWND WXUNUSED(hWnd)) const
	{
		return false;
	}
...
inline bool wxWindowMSW::GetUseCtl3D() const
{
	return false;
}
inline bool wxWindowMSW::GetTransparentBackground() const
{
	return false;
}
