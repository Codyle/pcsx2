...
public :
	...
	wxGraphicsObject &operator= (const wxGraphicsObject &other)
	{
		Ref(other);
		return *this;
	}
...
public :
	...
	wxGraphicsPen &operator= (const wxGraphicsPen &other)
	{
		Ref(other);
		return *this;
	}
...
public :
	...
	wxGraphicsBrush &operator= (const wxGraphicsBrush &other)
	{
		Ref(other);
		return *this;
	}
...
public :
	...
	wxGraphicsFont &operator= (const wxGraphicsFont &other)
	{
		Ref(other);
		return *this;
	}
...
public :
	...
	wxGraphicsBitmap &operator= (const wxGraphicsBitmap &other)
	{
		Ref(other);
		return *this;
	}
...
public :
	...
	wxGraphicsMatrix &operator= (const wxGraphicsMatrix &other)
	{
		Ref(other);
		return *this;
	}
...
public :
	...
	wxGraphicsPath &operator= (const wxGraphicsPath &other)
	{
		Ref(other);
		return *this;
	}
...
public :
	...
	wxGraphicsFigure &operator= (const wxGraphicsFigure &other)
	{
		Ref(other);
		return *this;
	}
