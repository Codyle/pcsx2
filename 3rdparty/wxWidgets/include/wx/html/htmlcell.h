...
public:
	...
	void ClearPrivPos()
	{
		m_toPrivPos = m_fromPrivPos = wxDefaultPosition;
	}
...
public:
	...
	{
		m_UseBorder = true;
		m_BorderColour1 = clr1, m_BorderColour2 = clr2;
	}
...
{
public:
	wxHtmlColourCell(const wxColour &clr, int flags = wxHTML_CLR_FOREGROUND) : wxHtmlCell()
	{
		m_Colour = clr;
		m_Flags = flags;
	}
...
{
public:
	wxHtmlFontCell(wxFont *font) : wxHtmlCell()
	{
		m_Font = (*font);
	}
	virtual void Draw(wxDC &dc, int x, int y, int view_y1, int view_y2,
