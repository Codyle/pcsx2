...
public:
	...
	virtual bool Write(wxSTD ostream &WXUNUSED(str)) const
	{
		return false;
	}
#endif
...
#if wxUSE_STD_IOSTREAM
	virtual bool Read(wxSTD istream &WXUNUSED(str))
	{
		return false;
	}
#endif
...
public:
	...
	inline operator wxArrayString() const
	{
