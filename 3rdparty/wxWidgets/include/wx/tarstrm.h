...
public:
	...
	bool CopyArchiveMetaData(wxTarInputStream &WXUNUSED(s))
	{
		return true;
	}
...
private:
	...
	bool CopyArchiveMetaData(wxArchiveInputStream &WXUNUSED(s))
	{
		return true;
	}
	bool IsOpened() const
