...
public:
	...
	const wxChar    *GetConnectionStr()
	{
		return ConnectionStr;
	}
	bool             UseConnectionStr()
	{
		return useConnectionStr;
	}
	...
	void             SetFileType(const wxString &fileType)
	{
		FileType      = fileType;
	}
...
public:
	...
	{
		dbIsCached = cached;        // This function must only be called by wxDbGetConnection() and wxDbCloseConnections!!!
	}
	bool             IsCached()
	{
		return dbIsCached;
	...
	const wxChar   *GetDatabaseName(void)
	{
		return dbInf.dbmsName;
	}
	const wxString &GetDataSource(void)
	{
		return dsn;
	}
	const wxString &GetDatasourceName(void)
	{
		return dsn;
	}
	const wxString &GetUsername(void)
	{
		return uid;
	}
	const wxString &GetPassword(void)
	{
		return authStr;
	}
	const wxString &GetConnectionInStr(void)
	{
		return inConnectionStr;
	}
	const wxString &GetConnectionOutStr(void)
	{
		return outConnectionStr;
	}
	bool            IsOpen(void)
	{
		return dbIsOpen;
	}
	bool            OpenedWithConnectionString(void)
	{
		return dbOpenedWithConnectionString;
	}
	HENV            GetHENV(void)
	{
		return henv;
	...
	int             GetTableCount()
	{
		return nTables;       // number of tables using this connection
	}
	wxDbSqlTypeInfo GetTypeInfVarchar()
	{
		return typeInfVarchar;
	}
	wxDbSqlTypeInfo GetTypeInfInteger()
	{
		return typeInfInteger;
	}
	wxDbSqlTypeInfo GetTypeInfFloat()
	{
		return typeInfFloat;
	}
	wxDbSqlTypeInfo GetTypeInfDate()
	{
		return typeInfDate;
	}
	wxDbSqlTypeInfo GetTypeInfBlob()
	{
		return typeInfBlob;
	}
	wxDbSqlTypeInfo GetTypeInfMemo()
	{
		return typeInfMemo;
	}
	...
	bool         FwdOnlyCursors(void)
	{
		return fwdOnlyCursors;
	}
