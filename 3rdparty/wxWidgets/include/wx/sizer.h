...
public:
	...
	wxSizerFlags &Left()
	{
		return Align(wxALIGN_LEFT);
	}
	wxSizerFlags &Right()
	{
		return Align(wxALIGN_RIGHT);
	}

#if wxABI_VERSION >= 20802
	wxSizerFlags &Top()
	{
		return Align(wxALIGN_TOP);
	}
	wxSizerFlags &Bottom()
	{
		return Align(wxALIGN_BOTTOM);
	}
#endif // wxABI 2.8.2+
...
public:
	...
	wxBookCtrlBase *GetControl() const
	{
		return m_bookctrl;
	}
