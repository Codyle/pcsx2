...
public:
	...
	{
		return (GetFlags() & wxTEXT_ATTR_FONT_WEIGHT) != 0;
	}
	bool HasFontSize() const
	{
		return (GetFlags() & wxTEXT_ATTR_FONT_SIZE) != 0;
	}
	bool HasFontItalic() const
	{
		return (GetFlags() & wxTEXT_ATTR_FONT_ITALIC) != 0;
	}
	bool HasFontUnderlined() const
	{
		return (GetFlags() & wxTEXT_ATTR_FONT_UNDERLINE) != 0;
	}
	bool HasFontFaceName() const
	{
		return (GetFlags() & wxTEXT_ATTR_FONT_FACE) != 0;
	}
	...
	{
		return (0 != (GetFlags() & wxTEXT_ATTR_CHARACTER));
	}
	bool IsParagraphStyle() const
	{
		return (0 != (GetFlags() & wxTEXT_ATTR_PARAGRAPH));
	}
...
public:
	...
	{
		return m_colText.Ok() && HasFlag(wxTEXT_ATTR_TEXT_COLOUR) ;
	}
	bool HasBackgroundColour() const
	{
		return m_colBack.Ok() && HasFlag(wxTEXT_ATTR_BACKGROUND_COLOUR) ;
	}
	...
	bool HasTabs() const
	{
		return (m_flags & wxTEXT_ATTR_TABS) != 0 ;
	}
	bool HasLeftIndent() const
	{
		return (m_flags & wxTEXT_ATTR_LEFT_INDENT) != 0 ;
	}
	bool HasRightIndent() const
	{
		return (m_flags & wxTEXT_ATTR_RIGHT_INDENT) != 0 ;
	}
	bool HasFontWeight() const
	{
		return (m_flags & wxTEXT_ATTR_FONT_WEIGHT) != 0;
	}
	bool HasFontSize() const
	{
		return (m_flags & wxTEXT_ATTR_FONT_SIZE) != 0;
	}
	bool HasFontItalic() const
	{
		return (m_flags & wxTEXT_ATTR_FONT_ITALIC) != 0;
	}
	bool HasFontUnderlined() const
	{
		return (m_flags & wxTEXT_ATTR_FONT_UNDERLINE) != 0;
	}
	bool HasFontFaceName() const
	{
		return (m_flags & wxTEXT_ATTR_FONT_FACE) != 0;
	}
	bool HasFont() const
	{
		return (m_flags & (wxTEXT_ATTR_FONT)) != 0;
	}

	bool HasParagraphSpacingAfter() const
	{
		return (m_flags & wxTEXT_ATTR_PARA_SPACING_AFTER) != 0;
	}
	bool HasParagraphSpacingBefore() const
	{
		return (m_flags & wxTEXT_ATTR_PARA_SPACING_BEFORE) != 0;
	}
	bool HasLineSpacing() const
	{
		return (m_flags & wxTEXT_ATTR_LINE_SPACING) != 0;
	}
	bool HasCharacterStyleName() const
	{
	...
	bool HasBulletStyle() const
	{
		return (m_flags & wxTEXT_ATTR_BULLET_STYLE) != 0;
	}
	bool HasBulletNumber() const
	{
		return (m_flags & wxTEXT_ATTR_BULLET_NUMBER) != 0;
	}
	bool HasBulletText() const
	{
		return (m_flags & wxTEXT_ATTR_BULLET_TEXT) != 0;
	}
	bool HasBulletName() const
	{
		return (m_flags & wxTEXT_ATTR_BULLET_NAME) != 0;
	}
	bool HasURL() const
	{
		return HasFlag(wxTEXT_ATTR_URL);
...
public:
	...
	virtual int HitTest(wxDC &WXUNUSED(dc), const wxPoint &WXUNUSED(pt), long &WXUNUSED(textPosition))
	{
		return false;
	}

	/// Finds the absolute position and row height for the given character position
	virtual bool FindPosition(wxDC &WXUNUSED(dc), long WXUNUSED(index), wxPoint &WXUNUSED(pt), int* WXUNUSED(height), bool WXUNUSED(forceLineStart))
	{
		return false;
	}
	...
	virtual wxRichTextObject* DoSplit(long WXUNUSED(pos))
	{
		return NULL;
	}
...
public:
	...
	wxRichTextBox(const wxRichTextBox &obj): wxRichTextCompositeObject()
	{
		Copy(obj);
	}
...
public:
	...
	wxRichTextParagraphLayoutBox(const wxRichTextParagraphLayoutBox &obj): wxRichTextBox()
	{
		Init();
		Copy(obj);
	}
	...
	{
		return wx_static_cast(int, GetChildCount());
	}
...
public:
	...
	wxRichTextParagraph(const wxRichTextParagraph &obj): wxRichTextBox()
	{
		Copy(obj);
	}
...
public:
	...
	wxRichTextPlainText(const wxRichTextPlainText &obj): wxRichTextObject()
	{
		Copy(obj);
	}
...
public:
	...
	wxRichTextImage(const wxRichTextImage &obj): wxRichTextObject()
	{
		Copy(obj);
	}
...
public:
	...
	wxRichTextBuffer(const wxRichTextBuffer &obj): wxRichTextParagraphLayoutBox()
	{
		Init();
		Copy(obj);
	}
