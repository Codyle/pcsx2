...
public:
	...
	inline wxUint32 LastCount() const
	{
		return m_lcount;
	}
	inline wxSocketError LastError() const
	{
		return (wxSocketError)m_socket->GetError();
	}
	void SaveState();
	void RestoreState();
	...
	inline wxSocketFlags GetFlags() const
	{
		return m_flags;
	}
	...
	inline wxUint32 GetLastIOSize() const
	{
		return m_lcount;
	}
	...
	inline bool IsNoWait() const
	{
		return ((m_flags & wxSOCKET_NOWAIT) != 0);
	}
	inline wxSocketType GetType() const
	{
		return m_type;
	}
