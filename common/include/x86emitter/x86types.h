...
public:
	...
	void prefix16() const
	{
		if (GetOperandSize() == 2) xWrite8(0x66);
	}
...
public:
	...
	bool IsSIMD() const
	{
		return GetOperandSize() == 8 || GetOperandSize() == 16;
	}

	bool operator==(const xRegisterBase &src) const
	{
		return (Id == src.Id);
	}
	bool operator!=(const xRegisterBase &src) const
...
public:
	...
	bool operator==(const xRegisterInt &src) const
	{
		return Id == src.Id && (GetOperandSize() == src.GetOperandSize());
	}
	bool operator!=(const xRegisterInt &src) const
	{
		return !operator==(src);
...
public:
	...
	bool operator==(const xRegister8 &src) const
	{
		return Id == src.Id;
	}
	bool operator!=(const xRegister8 &src) const
...
public:
	...
	bool operator==(const xRegister16 &src) const
	{
...
public:
	...
	bool operator==(const xRegister32 &src) const
	{
		return this->Id == src.Id;
	}
	bool operator!=(const xRegister32 &src) const
...
public:
	...
	bool operator==(const xRegisterMMX &src) const
	{
		return this->Id == src.Id;
	}
	bool operator!=(const xRegisterMMX &src) const
...
public:
	...
	bool operator==(const xRegisterSSE &src) const
	{
		return this->Id == src.Id;
	}
	bool operator!=(const xRegisterSSE &src) const
...
public:
	...
	operator const xRegisterBase &() const
	{
		return m_convtype;
	}
...
public:
	bool IsByteSizeDisp() const
	{
		return is_s8(Displacement);
	}
	...
	__fi xAddressVoid operator+(const xAddressReg &right) const
	{
		return xAddressVoid(*this).Add(right);
	}
	__fi xAddressVoid operator+(const xAddressVoid &right) const
	{
		return xAddressVoid(*this).Add(right);
	}
	__fi xAddressVoid operator+(s32 imm) const
	{
		return xAddressVoid(*this).Add(imm);
	}
	__fi xAddressVoid operator-(s32 imm) const
	{
		return xAddressVoid(*this).Add(-imm);
	...
	{
		return xAddressVoid(*this).Add((uptr)addr);
	}

	__fi void operator+=(const xAddressReg &right)
	{
		Add(right);
	}
	__fi void operator+=(s32 imm)
	{
		Add(imm);
	}
	__fi void operator-=(s32 imm)
...
public:
	...
	__fi xAddressInfo<BaseType> operator+(const xAddressReg &right) const
	{
		return xAddressInfo(*this).Add(right);
	}
	__fi xAddressInfo<BaseType> operator+(const xAddressInfo<BaseType> &right) const
	{
		return xAddressInfo(*this).Add(right);
	}
	__fi xAddressInfo<BaseType> operator+(s32 imm) const
	{
		return xAddressInfo(*this).Add(imm);
	}
	__fi xAddressInfo<BaseType> operator-(s32 imm) const
	{
		return xAddressInfo(*this).Add(-imm);
	...
	__fi void operator+=(const xAddressInfo<BaseType> &right)
	{
		Add(right);
	}
};
...
public:
	...
	__fi xIndirectVoid operator+(const s32 imm) const
	{
		return xIndirectVoid(*this).Add(imm);
	}
	__fi xIndirectVoid operator-(const s32 imm) const
	{
		return xIndirectVoid(*this).Add(-imm);
...
public:
	...
	__fi xIndirect<OperandType> operator+(const s32 imm) const
	{
		return xIndirect(*this).Add(imm);
	}
	__fi xIndirect<OperandType> operator-(const s32 imm) const
	{
		return xIndirect(*this).Add(-imm);
...
public:
	xIndirect32orLess(const xIndirect8 &src) : _parent(src)
	{
		m_OpSize = src.GetOperandSize();
	}
	xIndirect32orLess(const xIndirect16 &src) : _parent(src)
	{
		m_OpSize = src.GetOperandSize();
	}
	xIndirect32orLess(const xIndirect32 &src) : _parent(src)
	{
		m_OpSize = src.GetOperandSize();
	}
...
public:
	...
	const xModSibType &operator[](const xModSibType &src) const
	{
		return src;
	}
...
public:
	...
	const xSibType &GetMem() const
	{
		return m_MemIndirect;
	}
	bool IsDirect() const
	{
		return !m_RegDirect.IsEmpty();
	}
	...
	bool operator==(const xRegType &src) const
	{
		return (m_RegDirect == src);
	}
	bool operator!=(const xRegType &src) const
	{
		return (m_RegDirect != src);
